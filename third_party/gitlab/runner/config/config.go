...
type CacheS3Config struct {
	...
	AuthenticationType string `toml:"AuthenticationType,omitempty" long:"authentication_type" env:"CACHE_S3_AUTHENTICATION_TYPE" description:"IAM or credentials"`
}
...
type DockerConfig struct {
	...
	SysCtls                    map[string]string `toml:"sysctls,omitempty" json:"sysctls" long:"sysctls" env:"DOCKER_SYSCTLS" description:"Sysctl options, a toml table/json object of key=value. Value is expected to be a string."`
...
type DockerMachine struct {
	...
	OffPeakPeriods     []string                    `toml:"OffPeakPeriods,omitempty" description:"Time periods when the scheduler is in the OffPeak mode. DEPRECATED"`
	OffPeakTimezone    string                      `toml:"OffPeakTimezone,omitempty" description:"Timezone for the OffPeak periods (defaults to Local). DEPRECATED"`
	OffPeakIdleCount   int                         `toml:"OffPeakIdleCount,omitzero" description:"Maximum idle machines when the scheduler is in the OffPeak mode. DEPRECATED"`
	OffPeakIdleTime    int                         `toml:"OffPeakIdleTime,omitzero" description:"Minimum time after machine can be destroyed when the scheduler is in the OffPeak mode. DEPRECATED"`
...
type KubernetesContainerCapabilities struct {
	Add  []string `toml:"add" long:"add" env:"@ADD" description:"List of capabilities to add to the build container"`
	Drop []string `toml:"drop" long:"drop" env:"@DROP" description:"List of capabilities to drop from the build container"`
}
